...
I build infrastructure systems from the runtime layer.

Building **[KitWork Engine](https://github.com/kitwork/engine)**  a Go-based runtime with its own language and virtual machine.

One process. Many systems. No unnecessary complexity.
