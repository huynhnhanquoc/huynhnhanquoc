...
- I independently researched WPF, MVVM, Entity Framework, LINQ, Xamarin, Firebase Realtime Database (streaming Google Sheets JSON), Azure, Ionic, Cordova, and Progressive Web Apps (PWA).
